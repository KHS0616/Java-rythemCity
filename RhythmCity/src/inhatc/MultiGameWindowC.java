...
public class MultiGameWindowC extends JFrame{
	
	public static final int sizeW = 716;//365
	public static final int sizeH = 538;//538
	CenPan cenPan ;

	public MultiGameWindowC() {
		
	}
	public MultiGameWindowC(String userID, int musicID, String ip, int port) {
		super("Czerny");
		setSize(sizeW, sizeH);
		setLocationRelativeTo(null);
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		cenPan = new CenPan(userID, musicID, ip, port, this);
...
class CenPan extends JPanel implements KeyListener, ActionListener{
	...
	public CenPan(String userID, int musicID, String ip, int port, MultiGameWindowC gw) {
		//패널 기본 설정
		setLayout(null);
		setPreferredSize(new Dimension(MultiGameWindowC.sizeW,MultiGameWindowC.sizeH));
...
public static void main(String[] args) {
	new MultiGameWindowC("test",1,"localhost",9999);
}
}
